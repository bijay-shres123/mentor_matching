...
CustomAuthToken, StudentViewSet, MentorViewSet, 
PreferenceViewSet, create_preferences,
create_matching_mentor_mentee)
...
urlpatterns = [
    ...
    path('perform-matching', create_matching_mentor_mentee),
]